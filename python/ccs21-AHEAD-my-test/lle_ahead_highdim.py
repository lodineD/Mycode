...
def ahead_tree_query_error_recorder(ahead_forest, ahead_tree_list, real_frequency, query_interval_table, domain_size, MSEDict, domain_combination_list, data_dimension, fake_user):
    ...
    for i, query_interval in enumerate(query_interval_table):
        ...
        # 注入假用户
        if fake_user > 0:
            estimated_frequency_value_vector[0]= estimated_frequency_value_vector[0] + 0.1
        ...
        var_consistency = math.pow(real_frequency_value - estimated_frequency_value_vector[0], 2)
...
def main_fun(repeat_time, domain_size, branch, ahead_tree_height, theta, real_frequency, query_interval_table, epsilon, data_name, data_size_name, domain_name, data_dimension, dataset, data_size):
    ...
    while repeat < repeat_time:
        ...
        ahead_tree_query_error_recorder(ahead_forest, ahead_tree_list, real_frequency, query_interval_table, domain_size, MSEDict, domain_combination_list, data_dimension, fake_user=fake_user)
