...
# 老的数据集是一共100000个值
data_path_old = './dataset_origin/2dim_laplace01-set_10_5-domain8_attribute2-data.txt'
data_path_new = './dataset/2dim_laplace01-set_10_5-domain8_attribute2-data.txt'
