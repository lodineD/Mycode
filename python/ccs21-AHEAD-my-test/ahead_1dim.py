...
def ahead_tree_query_error_recorder(ahead_tree, real_frequency, query_interval_table, domain_size, MSEDict, fake_user):
    ...
    for i, query_interval in enumerate(query_interval_table):
        ...
        print('answer index {}-th quey'.format(i))
...
def main_func(repeat_time, domain_size, branch, ahead_tree_height, theta, real_frequency, query_interval_table, epsilon, data_path, data_name, data_size_name, domain_name):
    MSEDict = {'rand': []}
    repeat = 0
    ...
    while repeat < repeat_time:
        ...
        ahead_tree_construction(ahead_tree, ahead_tree_height, theta, branch, translation_vector, user_dataset_partition)
...
if __name__ == "__main__":
    ...
    # running 
    main_func(repeat_time, domain_size, branch, ahead_tree_height, theta, real_frequency, query_interval_table, epsilon, data_path, data_name, data_size_name, domain_name)
